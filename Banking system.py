...
def main_account_screen():
    ...
    Label(text="").pack()
    Button(text="Register", height="5", width="50", fg='black', bg='blue', font=("Arial Bold", 10),
           command=register).pack()
    Label(text="").pack()
    Button(text="Deposit", height="5", width="50", fg='black', bg='violet', font=("Arial Bold", 10),
           command=deposit).pack()
    Label(text="").pack()
    Button(text="Withdraw", height="5", width="50", fg='black', bg='orange', font=("Arial Bold", 10),
